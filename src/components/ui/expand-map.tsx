...
export function LocationMap({
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-5">
          ...
          <div className="flex items-start justify-between">
            ...
            {/* Status indicator */}
            <motion.div
              className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-foreground/5 backdrop-blur-sm border border-white/10"
              animate={{
            ...
            >
              ...
              <span className="text-[10px] font-mono font-medium text-muted-foreground tracking-wide uppercase">
                Private Dining
              </span>
            </motion.div>
          </div>
          ...
          <div className="space-y-1">
            <motion.h3
              className="text-foreground font-medium text-sm tracking-tight font-mono"
              animate={{
                x: isHovered ? 4 : 0,
              }}
            ...
            {/* Animated underline */}
            <motion.div
              className="h-px bg-gradient-to-r from-white/60 via-white/30 to-transparent"
      ...
      {/* Click hint */}
      <motion.p
        className="absolute -bottom-6 left-1/2 text-[10px] text-muted-foreground whitespace-nowrap font-mono"
        style={{ x: "-50%" }}
        initial={{ opacity: 0 }}
        animate={{
